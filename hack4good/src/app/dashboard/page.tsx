...
const tasks: Task[] = [
  { id: 1, name: 'Hallway cleaning', reward: 30, img: `https://cdn-icons-png.flaticon.com/512/9818/9818876.png`, claimed: false, distributed: false },
  { id: 2, name: 'Event organisation', reward: 15, img: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwNhe3i33SVxcmc8VeO8HhH3wJ0imFZB_PiQ&s`, claimed: true, distributed: false } ,
  { id: 3, name: 'Task 3', reward: 2, img: `https://via.placeholder.com/200`, claimed: false, distributed: false },
  { id: 4, name: 'Task 4', reward: 15, img: `https://via.placeholder.com/200`, claimed: true, distributed: false },
  { id: 5, name: 'Task 5', reward: 22, img: `https://via.placeholder.com/200`, claimed: false, distributed: false },
  { id: 6, name: 'Task 6', reward: 6, img: `https://via.placeholder.com/200`, claimed: true, distributed: false },
  { id: 7, name: 'Task 7', reward: 12, img: `https://via.placeholder.com/200`, claimed: false, distributed: false },
]
